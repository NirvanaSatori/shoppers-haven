      ...
      <div className="relative min-h-screen flex min-h-full items-center justify-center mt-20">
        <div className="flex flex-1 login-card shadow  bg-slate-100 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              <img
                className="logo w-auto shadow rounded-full mb-3 bg-white"
                src={shopperlogo}
                alt="Shoppers Haven"
              />
              ...
              <div className="mt-6">
                <form  className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="flex w-full justify-center rounded-md border border-transparent login-button py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                      Sign in
                    </button>
                  </div>
